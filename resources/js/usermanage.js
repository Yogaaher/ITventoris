document.addEventListener("DOMContentLoaded", () => {
        ...
        fetch(url, {
            ...
            .then((data) => {
                tableContainer.innerHTML =
                    data.table_html ||
                    '<div class="products-row"><div class="product-cell" style="text-align:center;flex-basis:100%;">Tidak ada pengguna.</div></div>';
                if (data.pagination) {
    ...
    tableContainer.addEventListener("click", function (event) {
        ...
        const currentUserRole = PAGE_DATA.isSuperAdmin
            ? "super_admin"
            : "admin";
        ...
        fetch(PAGE_DATA.urls.edit.replace("{id}", userId))
            ...
            .then((user) => {
                ...
                editForm.reset();
                document
                    .querySelectorAll("#editUserForm .invalid-feedback")
                    .forEach((el) => (el.textContent = ""));
                document
                    .querySelectorAll("#editUserForm .is-invalid")
                ...
                editForm.action = PAGE_DATA.urls.update.replace(
                    "{id}",
                    user.id
                );
    ...
    if (closeAddUserBtn)
        closeAddUserBtn.addEventListener("click", closeAddModal);
    if (cancelAddUserBtn)
